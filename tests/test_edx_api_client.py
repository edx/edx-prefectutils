...
class EdxApiClientTestCase(TestCase):
    ...
    def setUp(self):
        ...
        datetime_patcher = patch('prefect_utils.edx_api_client.datetime', MockDateTime)
    ...
    def test_secrets_from_config(self):
        ...
        client = EdxApiClient(client_id='cidfromcfg', client_secret='secfromcfg', auth_url=FAKE_AUTH_URL)
    ...
    def test_token_type(self):
        ...
        client = EdxApiClient(
            client_id='cidfromcfg',
            client_secret='secfromcfg',
    ...
    @patch('time.sleep', sleep_mock=None)
    def test_non_fatal_error(self, sleep_mock):
        self.prepare_for_token_request()
    ...
    @unpack
    @patch('time.sleep', sleep_mock=None)
    def test_paginated_get(self, response_bodies, pagination_key, sleep_mock):
        self.prepare_for_token_request()
        httpretty.register_uri('GET', FAKE_RESOURCE_URL,
                               responses=[
